...
const Layout = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen bg-background overflow-hidden relative print:h-auto print:overflow-visible print:block">
            <div className="print:hidden contents">
                <Sidebar />
            </div>
            <main className="flex-1 overflow-y-auto relative pb-20 md:pb-0 print:overflow-visible">
